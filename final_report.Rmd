...
# ```{r,echo=FALSE}
# #cat("K", "\t", "AIC", "\t\t", "BIC", "\n")
# lowest_bic = lowest_aic = 100000000
# best_k_bic = best_k_aic = 0
# for (k in 3:100) {
#   aic_bic_k = aic_bic(kmeans(ssctn[], centers = k, nstart = 20,algorithm = 'Lloyd',iter.max=150))
...
# 
# ```{r}
# cat('Best K according to AIC: ', best_k_aic, '-- AIC: ', lowest_aic, '\n')
# ```
# 
# ```{r}
